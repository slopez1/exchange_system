...
class EthereumSmartContractInterface(SmartContractInterface):

    def __init__(self, provider_url: str, account_path: str, keystore_password: str, smc_address: str):
        """
        ...
        """
        self.private_key = _get_private_key_from_account_path(account_path, keystore_password)
